 ...
 * 关联告警选择table配置
 */
export function initAlarmTableConfig(that) {
  that.tableConfig = {
    isDraggable: true,
    isLoading: false,
    ...
    columnConfig: [
      ...
      {
        // 告警名称
        title: that.alarmLanguage.alarmName,
        key: 'alarmName',
        width: 150,
        searchable: true,
        isShowSort: true,
      ...
      {
        // 告警级别
        title: that.alarmLanguage.alarmDefaultLevel,
        key: 'alarmFixedLevel',
        width: 120,
        searchable: true,
        isShowSort: true,
      ...
      {
        // 告警对象
        title: that.alarmLanguage.alarmobject,
        key: 'alarmObject',
        width: 150,
        searchable: true,
        isShowSort: true,
      ...
      {
        // 告警类别
        title: that.alarmLanguage.AlarmType,
        key: 'alarmClassificationName',
        width: 150,
        isShowSort: true,
        configurable: true,
        searchable: true,
      ...
      {
        // 区域
        title: that.alarmLanguage.areaName,
        key: 'areaName',
        width: 120,
        searchable: true,
        isShowSort: true,
      ...
      {
        // 设施类型
        title: that.alarmLanguage.alarmSourceType,
        key: 'deviceTypeName',
        width: 150,
        searchable: true,
        isShowSort: true,
      ...
      {
        // 设施名称
        title: that.alarmLanguage.deviceName,
        key: 'alarmDeviceName',
        width: 150,
        isShowSort: true,
        searchable: true,
      ...
      {
        // 设备类型
        title: that.alarmLanguage.equipmentType,
        key: 'equipmentType',
        width: 160,
        configurable: true,
        searchable: true,
      ...
      {
        // 频次
        title: that.workOrderLanguage.frequency,
      ...
      {
        // 清除状态
        title: that.language.alarmCleanStatus,
        key: 'alarmCleanStatusName',
        width: 150,
        isShowSort: true,
        configurable: true,
        searchable: true,
      ...
      {
        // 确认状态
        title: that.language.alarmConfirmStatus,
        key: 'alarmConfirmStatusName',
        width: 120,
        isShowSort: true,
        configurable: true,
        searchable: true,
      ...
      {
        // 首次发生时间
        title: that.language.alarmBeginTime,
        key: 'alarmBeginTime',
        width: 180,
        isShowSort: true,
        searchable: true,
 ...
 * 表单中单位选择
 */
export function initUnitTreeConfig(that) {
 ...
 * 关联告警中列表单位选择
 */
export function initUnitTreeSelectConfig(that) {
