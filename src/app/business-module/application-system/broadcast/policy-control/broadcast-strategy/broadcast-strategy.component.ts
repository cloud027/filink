...
import {InstructBroadcastModel, ProgramListModel, SelectedProgramModel, StrategyListModel, StrategyPlayPeriodRefListModel} from '../../../share/model/policy.control.model';
...
@Component({
  selector: 'app-broadcast-strategy',
  templateUrl: './broadcast-strategy.component.html',
  styleUrls: ['./broadcast-strategy.component.scss']
})
export class BroadcastStrategyComponent implements OnInit {
  // 展示时长
  public showTime = 1;
  // 循环模式
  public instructBroadcast: InstructBroadcastModel = new InstructBroadcastModel();
  // 节目列表
  ...
  // 选中的节目
  public selectedProgram = {id: '', name: '', duration: ''};
  // 播放时段集合
  ...
  public handleAddProgram(): void {
    ...
    this.selectedProgram = {name: '', id: '', duration : ''};
    this.showTime = 1;
  }
  ...
  public handleProgramOk(selectedProgram): void {
    this.selectedProgram = {id: selectedProgram.id, name: selectedProgram.name, duration: selectedProgram.duration};
