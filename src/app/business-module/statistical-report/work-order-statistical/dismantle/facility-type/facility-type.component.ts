...
@Component({
  selector: 'app-dismantle-facility-type',
  templateUrl: '../../template-work-order.html',
  styleUrls: ['../../template-work-order.scss']
})
export class DismantleFacilityTypeComponent extends WorkCommon {
  ...
  public statistical(): void {
    ...
    this.refreshTypeData({'queryType': '6', 'procType': '5'});
  }

  public initTableClearConfig(): void {
    this.initPublicTableConfig(180, this.getSelectTypeColumn(), 'dismantleDeviceTypeExport', '1000px', ExportWorkOrderDeviceTypeEnum);
  }
}
