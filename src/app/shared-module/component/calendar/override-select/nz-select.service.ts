...
import { NzOptionGroupComponent, isNotNil } from 'ng-zorro-antd';
...
export class NzSelectService {
  ...
  private mapOfTemplateOption$ = new BehaviorSubject<{
    listOfNzOptionComponent: OverrideNzOptionComponent[],
  ...
  private listOfFilteredOption: OverrideNzOptionComponent[] = [];
  ...
  activatedOption: OverrideNzOptionComponent;
  activatedOption$ = new ReplaySubject<OverrideNzOptionComponent>(1);
  ...
  // flat ViewChildren
  listOfTemplateOption: OverrideNzOptionComponent[] = [];
  // tag option
  listOfTagOption: OverrideNzOptionComponent[] = [];
  // tag option concat template option
  listOfTagAndTemplateOption: OverrideNzOptionComponent[] = [];
  // ViewChildren
  listOfNzOptionComponent: OverrideNzOptionComponent[] = [];
  listOfNzOptionGroupComponent: NzOptionGroupComponent[] = [];
  // click or enter add tag option
  addedTagOption: OverrideNzOptionComponent;
  // display in top control
  listOfCachedSelectedOption: OverrideNzOptionComponent[] = [];
  ...
  clickOption(option: OverrideNzOptionComponent): void {
  ...
  updateListOfTagOption(): void {
    if (this.isTagsMode) {
      ...
      this.listOfTagOption = listOfMissValue.map(value => {
        const nzOptionComponent = new OverrideNzOptionComponent();
  ...
  updateAddTagOption(): void {
    ...
    if (this.isTagsMode && this.searchValue && !isMatch) {
      const option = new OverrideNzOptionComponent();
  ...
  updateActivatedOption(option: OverrideNzOptionComponent): void {
  ...
  updateTemplateOption(listOfNzOptionComponent: OverrideNzOptionComponent[], listOfNzOptionGroupComponent: NzOptionGroupComponent[]): void {
  ...
  // tslint:disable-next-line:no-any
  removeValueFormSelected(option: OverrideNzOptionComponent): void {
