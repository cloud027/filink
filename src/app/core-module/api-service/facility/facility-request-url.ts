...
export const FacilityRequestUrl = {
  ...
  // 查询设施类型数量New
  queryDeviceTypeCountNew: `${DEVICE_SERVER}/statistics/queryDeviceTypeCountNew`,
  // 查询设备统计
  equipmentCount: `${DEVICE_SERVER}/statistics/queryEquipmentTypeCount`,
  // 查询设备统计New
  equipmentCountNew: `${DEVICE_SERVER}/statistics/queryEquipmentTypeCountNew`,
  // 查询回路详情
  ...
  queryCodingRulePageByType: `${DEVICE_SERVER}/codingRule/queryCodingRulePageByType`,
  // 通过选择的编码标准查询中标的设施列表
  getHitDevicePage: `${DEVICE_SERVER}/codingRule/getHitDevicePage`,
  // 通过选择的编码标准查询中标的设备列表
  getHitEquipmentPage: `${DEVICE_SERVER}/codingRule/getHitEquipmentPage`,
  // 设施批量编码
  batchUpdateDeviceCode: `${DEVICE_SERVER}/generateAssetCode/batchUpdateDeviceCode`,
  // 设备批量编码
  batchUpdateEquipmentCode: `${DEVICE_SERVER}/generateAssetCode/batchUpdateEquipmentCode`,
  //  杆型图详情
  poleImageInfo: `${PRODUCT_SERVER}/productImage/poleImageInfo`,
  // 新增或编辑设施设备时，判断表单资产编码字段是否禁用
  checkCodingRule: `${DEVICE_SERVER}/codingRule/checkCodingRule`
};
