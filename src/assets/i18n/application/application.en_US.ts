export default {
  ...
  policyControl: {
    ...
    information: 'Info release strategy',
  ...
  equipmentTable: {
    ...
    insertBroadcast: 'insert broadcast',
    insertBroadcastName: 'insert broadcast name',
    onlineBroadcast: 'online broadcast',
    volume: 'volume',
    stopBroadcast: 'stop',
    call: 'call',
    monitor: 'monitor',
    confirmCall: 'Are you sure to call',
    confirmMonitor: 'Are you sure to monitor',
    address: 'address',
    equipmentDevice: 'equipment device',
  ...
  strategyList: {
    ...
    broadcastStrategy: 'Broadcast release strategy',
    day: 'Day',
    more: 'more',
    ...
    effectivePeriodTime: 'Valid period',
    ...
    confirm: 'Confirm',
    cancel: 'Cancel',
    strategyDetails: 'Strategy Particular',
    ...
    alarmStatistics: 'Alarm Type Statistics',
    ...
    effectivePeriodStart: 'Start Time',
    effectivePeriodEnd: 'End Time',
    ...
    conflictTip: 'There are other operations at that point in time',
    onlyEndTime: 'only end time error',
    canNotChooseOff: 'Can not choose off at the time',
    ...
    strategyTip: 'The number of times the lighting strategy is turned off cannot be greater than the number of times it is turned on'
  },
  // 内容列表
  contentList: {
    programName: 'Program name',
    ...
    preview: 'Preview',
    chooseScreen: 'Choose Screen Model',
    ...
    distribution: 'The order has been issued',
    ...
    fileMsg: 'Please upload files less than 100MB',
  ...
  auditContent: {
    ...
    desc: 'Description',
    historyProcess: 'History process',
  },
  // 信息工作台
  informationWorkbench: {
    ...
    programLaunchQuantity: 'Equipment programs number',
    playingTime: 'Equipment playback time',
  ...
  securityWorkbench: {
    ...
    notFoundEquipment: 'Not Found Equipment',
    tip: 'Please input user name, password and channel number'
  },
  // 设备地图
  equipmentMap: {
  ...
  frequentlyUsed: {
    ...
    workOrder: 'Work order increment',
    increaseWorkOrder: 'Content work order increment',
    ...
    uploadAudioTips: 'Please upload MP3 files',
  ...
  reportAnalysis: {
    ...
    powerFactorReport: 'PowerFactor Report',
  ...
  // 环境监测工作台
  MonitorWorkbench: {
    workbench: 'Monitor release workbench',
    numberMonitors: 'Number of environmental monitors',
    tipInfo: 'There\'s no environmental monitor yet',
    basicInformation: 'Basic information of environmental monitoring',
    region: 'Region',
    ...
    PM10 : 'PM10',
    noise: 'Noise',
    monitoringPointData: 'Monitoring Point Data',
    addAttention: 'Add Attention',
    groupChange: 'Group Change',
    cancelFollow: 'Are you sure you want to cancel the follow?',
    collectSuccess: 'Collect Success',
    notGroup: 'Not Group',
    loop: 'loop',
  },
  ...
  broadcastWorkbench: {
    ...
    createIt: 'There\'s no one click call yet',
    workbench: 'Information release workbench',
    batchDownloadSuccess: 'Batch download success',

  },
  // 一键呼叫工作台
  callWorkbench: {
    equipmentSearch: 'Please enter equipment name',
    noEquipmentSelected: 'No Equipment Selected',
    geographicalPosition: 'Geographical Position',
    workOrder: 'Work order increment',
    callInformation: 'call Information',
    allEquipment: 'GIS Map',
    call: 'Call',
    region: 'region',
    facilities: 'facilities',
    information: 'There is no more information~',
    equipmentStatus: 'Statistics of equipment status',
    quantityStatistics: 'Statistics of alarm classification quantity',
    createIt: 'You haven\'t released any call yet.',
    workbench: 'One touch call workbench',
    wisdomPoles: 'Number of smart sticks',
    calls: 'Number of smart calls',
    calltype1: 'Calling',
    calltype2: 'Monitoring',
    calltype3: 'Intercoming',
    calltype4: 'Hang Up',
    calltype5: 'Cancel',
  ...
  historyAudioList: {
    historyAudioList: 'History audio list',
