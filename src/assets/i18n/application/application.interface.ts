export interface ApplicationInterface {
  ...
  equipmentTable: {
    ...
    insertBroadcast: string;
    insertBroadcastName: string;
    onlineBroadcast: string;
    volume: string;
    stopBroadcast: string;
    call: string;
    monitor: string;
    confirmCall: string;
    confirmMonitor: string;
    address: string;
  ...
  broadcastWorkbench: {
    ...
    workbench: string;
    deleteOthers;
    batchDownloadSuccess: string;
  };
  // 一键呼叫工作台
  callWorkbench: {
    equipmentSearch: string,
    noEquipmentSelected: string,
    geographicalPosition: string,
    workOrder: string,
  ...
  stateOnMeeting: string;
  stateCalling: string;
  stateListening: string;
  stateBroadcasting: string;
  stateListened: string;
  stateCalled: string;
  basicInformation: string;
  finish: string;
}
