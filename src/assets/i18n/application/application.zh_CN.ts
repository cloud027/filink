export default {
  ...
  equipmentTable: {
    ...
    insertBroadcast: '插播',
    insertBroadcastName: '插播名称',
    onlineBroadcast: '现场广播',
    volume: '音量',
    stopBroadcast: '停止插播',
    call: '呼叫',
    monitor: '监听',
    confirmCall: '确认开始呼叫吗',
    confirmMonitor: '确认开始监听吗',
    address: '地址',
    equipmentDevice: '所属设施',
    deviceType: '设施类型',
  },
  electricityDate: {
    week: '周',
  ...
  strategyList: {
    ...
    sameTimeErrorTip: '新增的子策略时间与已存在的子策略时间重合时，仅允许其中一条为纯调光方可添加',
    conflictTip: '该时间点已存在其他操作',
    onlyEndTime: '不能只选结束时间',
    canNotChooseOff: '时间点不能选择关',
    deleteMsg: '删除策略成功！',
    sunrise: '日出',
    sunset: '日落',
    custom: '自定义时段',
  ...
  MonitorWorkbench: {
    workbench: '环境监测工作台',
    numberMonitors: '环境监测仪数量',
    tipInfo: '还没有环境监测仪',
    basicInformation: '环境监测基本信息',
    region: '所属区域',
    facilities: '所属设施',
    monitor: '微气象仪',
    allEquipment: '全部设备',
    ...
    PM10: 'PM10',
    noise: '噪声',
    monitoringPointData: '监测点数据',
    addAttention: '添加关注',
    groupChange: '分组变更',
    cancelFollow: '是否确定取消关注？',
    collectSuccess: '关注成功',
    notGroup: '未分组',
    loop: '所属回路',
  },
  broadcastWorkbench: {
    ...
    programLaunchQuantity: '设备节目投放数量',
    playingTime: '设备播放时长',
    createIt: '还没有广播发布信息哦，快去创建吧 ',
    workbench: '广播发布工作台',
    batchDownloadSuccess: '批量下载成功',
  },
  // 一键呼叫工作台
  callWorkbench: {
    equipmentSearch: '请输入设备名称',
    noEquipmentSelected: '暂未选中设备',
    geographicalPosition: '地理位置',
    workOrder: '工单增量',
    callInformation: '一键呼叫信息',
    allEquipment: 'GIS地图',
    call: '呼叫',
    region: '所属区域',
    facilities: '所属设施',
