export default {
  ...
  materialUnitPrice: 'Unit Price(yuan)',
  supplier: 'Supplier',
  ...
  exportStorageSuccess: 'Export inventory overview Successfully!',
  ...
  selectDeviceMaterialTip: 'The user does not have permission to view the device',
  selectFacilityMaterialTip: 'The user does not have permission to view the facility',
  deleteDeliverySuccess: 'Deleted outbound materials successfully!',
  unit: 'Unit: PCS',
};
